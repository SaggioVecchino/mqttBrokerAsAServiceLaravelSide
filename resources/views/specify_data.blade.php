        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    Specify data you want to get from the project:
                    <br>
                    <b>ID:</b> {{$project->id}}
                    <br>
                ...
                <div class="card-body">
                    ...
                    <b>Interval :</b>{{Form::select('interval', array('Y' => 'Year', 'M' => 'Month', 'W' => 'Week', 'D' => 'Day',
                    'H' => 'Hour'))}}
                    <br>
                    <b>Frequence: </b>{{Form::select('freq', array('M' => 'Month', 'W' => 'Week', 'D' => 'Day', 'H' => 'Hour',
                    'Mn' => 'Minute'))}}
                    <br>
                    <b>Aggregate: </b>{{Form::select('agg', array( 'avg' => 'avg', 'max' => 'max', 'count' => 'count', 'min'
                    => 'min', 'sum' => 'sum'))}}
                    <br>
                    <b>Type of graph: </b>{{Form::select('type', array( 'line' => 'Line', 'bar' => 'Bar' ))}} {{ Form::submit('OK')
                    }} {{ Form::close() }}
                    <br>
                </div>
            </div>
